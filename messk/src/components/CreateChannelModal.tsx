...
export const CreateChannelModal: React.FC<CreateChannelModalProps> = ({ onClose, onCreated }) => {
  const titleId = 'create-channel-dialog-title';
  const descriptionId = 'create-channel-dialog-description';
    ...
    >
        <div className="flex items-center justify-between border-b border-white/10 px-6 py-5">
          <div>
            ...
            <h2 id={titleId} className="mt-1 text-[30px] font-semibold leading-tight tracking-[-0.02em] text-white">Create a broadcast space</h2>
            <p id={descriptionId} className="mt-2 max-w-2xl text-sm leading-6 text-text-muted">
              Create a channel shell with readable role and permission guidance.
            </p>
          </div>
          <button
            type="button"
