...
- Confirm native zeroization tests pass for X3DH/ratchet secret state and web crypto paths still wipe mutable temporary seed, direct/ratchet, group, PIN vault, attachment, and backup buffers after use.
